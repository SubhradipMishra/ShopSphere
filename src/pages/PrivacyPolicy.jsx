...
const PrivacyPolicy = () => {
  return (
    ...
    >
      ...
      <p>
        If you have any questions about this Privacy Policy, please contact us at <a href="mailto:shopsphere@example.com" className="underline hover:text-blue-400">shopsphere@gmail.com</a>.
      </p>
    </motion.div>
  );
};
